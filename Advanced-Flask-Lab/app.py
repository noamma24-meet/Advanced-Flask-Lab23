...
socials=["https://twitter.com/i/flow/login?redirect_after_login=%2FDrMayaAngelou","https://www.facebook.com/arianagrande/","https://www.whitehouse.gov/administration/vice-president-harris/","https://www.whitehouse.gov/administration/vice-president-harris/"]



@app.route('/')  # '/' for the default page
def home():
    return render_template('index.html',bio=user_bio, myposts=posts,linkimg=image_link, social=socials)
